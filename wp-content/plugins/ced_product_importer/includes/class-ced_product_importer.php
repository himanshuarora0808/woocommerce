...
class Ced_product_importer {
	...
	public function __construct() {
		...
		$this->plugin_name = 'ced_product_importer';
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-ced_product_importer-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-ced_product_importer-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-ced_product_importer-admin.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-ced_product_importer-public.php';
	...
	private function define_admin_hooks() {
		...
		$this->loader->add_action( 'admin_menu', $plugin_admin, 'ced_create_import_product_menu' );

		$this->loader->add_action( 'admin_menu', $plugin_admin, 'ced_create_order_menu' );
 
		// hook for displaying content through ajax
		$this->loader->add_action( 'wp_ajax_product_files_ajax', $plugin_admin, 'ced_display_products_ajax' );

		// hook for creating product through ajax
		$this->loader->add_action( 'wp_ajax_import_files_ajax', $plugin_admin, 'ced_create_products_ajax' );
		
		$this->loader->add_action( 'wp_ajax_import_bulk_files_ajax', $plugin_admin, 'ced_bulk_import' );

		$this->loader->add_action( 'wp_ajax_create_order_ajax', $plugin_admin, 'ced_create_order' );
	}
