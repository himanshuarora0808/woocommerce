 ...
 *
 * @wordpress-plugin
 * Plugin Name:       Ced_Product_importer
 ...
 * Text Domain:       ced_product_importer
 ...
 * This action is documented in includes/class-ced_product_importer-activator.php
 */
function activate_ced_product_importer() {
	require_once plugin_dir_path( __FILE__ ) . 'includes/class-ced_product_importer-activator.php';
	Ced_product_importer_Activator::activate();
}

/**
 * The code that runs during plugin deactivation.
 * This action is documented in includes/class-ced_product_importer-deactivator.php
 */
function deactivate_ced_product_importer() {
	require_once plugin_dir_path( __FILE__ ) . 'includes/class-ced_product_importer-deactivator.php';
 ...
 */
require plugin_dir_path( __FILE__ ) . 'includes/class-ced_product_importer.php';
